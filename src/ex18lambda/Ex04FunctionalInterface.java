...
public class Ex04FunctionalInterface {
	 ...
	 * 아래와 같이 매개변수로 전달받은 뒤 추상매서드인 studyLambda()를 호출 가능
	 */
	...
	public static void main(String[] args) {
		 ...
		 */
		ISchool4 sch = (str) ->
		System.out.println("ISchool4를 구현받아 정의한 람다" + str);
		
		/*
		 * 앞에서 정의한 람다식을 매서드의 인수로 전달한다. 이때 람다식 자체가
		 * 전달되는 것이 아니라 참조값만 전달된다. 참조값을 통해 우리는 람다식의
		 * 기능을 호출할 수 있다.
		 */
