...
class FruitSeller {
	...
	/*
	 * 멤버변수에 private 접근지정자를 추가함. 이렇게 하면 클래스 내부에서만 접근가능하고,
...
class FruitBuyer {
	...
	public FruitBuyer(int _money, int _numOfApple) {
		myMoney = _money;
...
public class E03InfomationHiding {
	...
	public static void main(String[] args) {
		 ...
		 * 멤버메서드를 통한 구매이므로 판매의 규칙이 잘 지켜짐
		 * 이와 같은 이유로 객체지향 프로그래밍에서는 "정보은닉"을 권장
		 */
