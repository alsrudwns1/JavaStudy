...
/*
 * 클래스 생성 시 정렬의 기준을 만들어주기 위해서는 Comparable<T> 인터페이스를
 * 구현해야 한다.	
 */
class MyString implements Comparable<MyString> {
	 ...
	 * 오버라아딩 한다. 정렬의 기준은 단순히 가나다 같은 순서가 될 수도 있고,
	 * 문자열의 길이에 따른 정렬이 될 수도 있다.
	 * 아래의 코드는 오름차순 정렬일 때 쓴다.
...
public class Ex05TreeSetMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("저장된 데이터 수:" + tree1.size() + "개"); //4개출력
