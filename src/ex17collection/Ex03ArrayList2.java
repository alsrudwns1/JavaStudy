...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 아래 2개의 컬렉션은 내부적인 자료구조만 다를 뿐 구현방법의 차이는 없다.
		 * 인스턴스 생성 시 student 형의 타입매개변수를 통해 생성.
		 * 즉 student 인스턴스를 통해 저장할 수 있는 상자가 됨.
		 */
		...
		/*
		 * 시나리오] 커렉션에 저장된 인스턴스를 이름으로 검색하여 지우는 코드를
		 * 작성하시오, 이때 반복문은 확장for문을 사용.
		 */
		...
		for(Student st : list2) {
			...
			//getter를 통해 접근해야 한다. 삭제를 위해 입력한 이름과 student
