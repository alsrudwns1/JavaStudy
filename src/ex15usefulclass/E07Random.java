...
public class E07Random {
	...
	public static void main(String[] args) {
		...
		/*
		 * random 클래스는 인스턴스 생성 시 전달되는 인수를 기반으로 난수를
		 * 생성한다. 이것을 seed(씨앗)라고 표현한다. 만약 동일한 seed를 사용하면
		 * 항상 동일한 패턴의 난수가 생성되는데
		...
		/*
		 * nextInt에 인수가 없는 경우 음수,양수가 혼용된 난수가 생성된다.
		 * 이 경우 math.abs()를 통해 양수로 변환하고 특정수를 나누는 형태로
		 * 필요한 난수를 생성 가능
		 */
