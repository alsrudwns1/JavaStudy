...
public class Ex02PreDefineException6 {
	...
	public static void main(String[] args)  {	
		...
		/*
		 * object 클래스를 단독적으로 생성한 경우 다른 클래스와의 상속관계가
		 * 전혀 없는 상태이므로 이 상태에서는 형변환을 할 수가 없어
		 * 예외가 발생한다.
		 */
  
		Object object = new Object();
		try {
			//순수한 object 객체이므로 자식 타입으로 형변환 불가능.
	...
	/*
	 * string 인스턴스가 인수로 전달되며 매개변수를 통해 object로 자동형변환
	 * 되므로 여기서 상속관계가 확인된다. 매개변수 o는 원래 string 타입
	 * 이었으므로 instanceof를 통해 string 임을 확인할 수 있고 이 경우에는
	 * 다운캐스팅이 가능하게 된다.
	 */
